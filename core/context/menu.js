export default {
	...
	footer: [
		{ name: 'О препарате', link: { href: '/about' } },
		{ name: 'Показания', link: { href: '/indications' } },
		{ name: 'Клинические исследования', link: { href: '/clinical-research' } },
		{ name: 'О Biocad', link: { href: '/biocad' } },
		{ name: 'Публикации', link: { href: '/publications' } },
		{ name: 'Лекции', link: { href: '/lectures' } }
	]
}
