...
default-src 'self';
script-src 'self' 'unsafe-eval' 'unsafe-inline' *.biocadless.com *.googleapis.com *.gstatic.com *.googletagmanager.com *.google-analytics.com *.doubleclick.net *.youtube.com *.yandex.ru *.salesforce.com *.twitter.com *.usefathom.com;
child-src *.biocadless.com *.google.com *.gstatic.com *.doubleclick.net *.youtube.com *.salesforce.com *.twitter.com;
style-src 'self' 'unsafe-inline' *.googleapis.com *.gstatic.com *.cloudflare.com;
font-src 'self' 'unsafe-eval' *.gstatic.com;
img-src * blob: data: *.biocadless.com;
frame-src 'self';
media-src *;
connect-src *;
`
